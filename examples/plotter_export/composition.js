(function(global) {
  ...
  function build(options) {
    ...
    // 1. Three open frames hold the page together.
    ...
    // 2. A ruled field and machine symbols build the lower texture.
    ...
    // 3. Red marks keep their canvas colour and enter the red SVG layer.
    ...
    // 4. The remaining words use the black layer unless red is stated.
